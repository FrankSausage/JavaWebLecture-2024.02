...
<body style="margin: 50px;">
	...
	<table border="1">
		<tr><th>표현 방법</th><th>결과</th></tr>
			...
			<tr><td>통화(USD)</td><td><fmt:formatNumber type="currency" currencySymbol="USD" value="${price}" /></td></tr>
			<tr><td>퍼센트</td><td><fmt:formatNumber type="percent" value="${price / 100000}" /></td></tr>
			...
			<tr><td>pattern("YYYY-MM-dd HH:mm:ss")</td><td><fmt:formatDate pattern="YYYY-MM-dd HH:mm:ss" value="${now}" /></td></tr>
			<tr><td>pattern("YY-MM-dd HH:mm")</td><td><fmt:formatDate pattern="YY-MM-dd HH:mm" value="${now}" /></td></tr>
