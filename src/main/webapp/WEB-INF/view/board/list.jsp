...
<head>
	...
	<script>
		function search() {
			...
			location.href = '/jw/bbs/board/list?p=${currnetBoardPage}&f=' + field + '&q=' + query;
		}
	</script>
</head>
	<body>
					...
					<table class="table table-sm table-borderless">
						<tr>
							<td style="width: 52%; text-align: left">
								<h3><strong class="me-5"><a href="/jw/bbs/board/list?p=1" style="color: black">게시글 목록</a></strong>
									<span style="font-size:16px"><a href="/jw/bbs/board/insert"><i class="fa-solid fa-pen-to-square"></i> 글쓰기</a></span>
								</h3>
							</td>
							<td style="width: 16%">
					...
					<ul class="pagination justify-content-center">
					  ...
					  <c:forEach var="page" items="${pageList}">
					  	<li class="page-item ${currentBoardPage eq page ? 'active' : ''}">
					  		<a class="page-link" href="/jw/bbs/board/list?p=${page}&f=${title}&q=${query}">${page}</a>
					  	</li>
					  </c:forEach>
